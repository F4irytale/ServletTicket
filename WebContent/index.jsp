...
<body>
	<div style="width: 1380px;height: 80px; margin-left: 130px;">
	...
	<div style="width:1540px;height:40px;background-color:#f9e9cd">
		<%@include file = "daohang.html" %>
	</div>
	<img src="img/gaotie.jpg" style="width: 1540px;height: 550px; z-index: 0;position: absolute;border-radius:5px;">
	...
	<div style="width:1540px;height: 300px;text-align: center;margin-top: 150px; background-color:#f8ebe6;">
